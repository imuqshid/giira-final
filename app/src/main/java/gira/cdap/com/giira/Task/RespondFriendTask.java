...
public class RespondFriendTask extends AsyncTask<String,Void,String> {

    ServiceHandler serviceHandler ;
    InputStream inputStream;
    JSONParser parsing;
    String user_from,user_to,response;
    UserProfileActivity userProfileActivity;

    Context context;


    public RespondFriendTask(Context context, String user_from, String user_to, String response, UserProfileActivity userProfileActivity)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        value.add(new BasicNameValuePair("response", response));

        android.util.Log.d("Task","AddRequestTask");
        serviceHandler = new ServiceHandler();
        inputStream = serviceHandler.makeServiceCall(
                serverURL.local_host_url+"giira/index.php/friends/respondrequest",2,
                value);
    ...
    protected void onPostExecute(String result) {
        ...
        {
                Toast.makeText(context, "Respond failed", Toast.LENGTH_SHORT).show();
        }
